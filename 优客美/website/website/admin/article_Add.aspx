<%@ Page Language="C#" AutoEventWireup="false" validateRequest="false" CodeBehind="article_Add.aspx.cs" Inherits="website.admin.article_Add" %>
...
<body>
    ...
    <fieldset >
     <legend>文章添加</legend>
     <form id="frmAddArticle" method="post" class="form-horizontal" action="ashxFile/Article.ashx?par=AddArticle">
         <div class="title">
    ...
    <p class="conbutton"><span onclick="infoclear()">取消</span><span onclick="AddArticle()">添加</span></p>
    </fieldset>   
    <!------------------------------end---------------------------------------->
